package cn.milo.wechat.SendTemplate;
...
public class Template extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            log.info(HttpUtil.doPost("https://api.weixin.qq.com/cgi-bin/message/template/send?access_token="+ AccessToken.AccessToken,requestSTR));
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
